  ...
  const networkCard = () => {
    const options = [
      ...
      },
      {
        ...
        dataIndex: 'cni.cilium.ipam.operator.clusterPoolIPv4PodCIDRList',
        render: (value = []) => (value || []).join(', '),
      },
      {
        label: t('IPv4 Mask Size'),
        dataIndex: 'cni.cilium.ipam.operator.clusterPoolIPv4MaskSize',
      },
      {
        label: t('Kube Proxy Replacement'),
        dataIndex: 'cni.cilium.kubeProxyReplacement',
      },
      {
        label: t('Operator Replicas'),
        dataIndex: 'cni.cilium.operator.replicas',
      },
      ...networkItem(),
      {
        label: t('MTU'),
