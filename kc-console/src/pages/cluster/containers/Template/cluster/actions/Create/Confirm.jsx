...
export class ConfirmStep extends BaseForm {
  ...
  getClusterItems = () => {
    ...
    return [
      ...
      {
        label: t('CNI Version'),
        value: cniType === 'calico' ? calicoVersion : ciliumVersion,
      },
      ...(cniType === 'calico'
        ? [
            {
        ...
        ? [
            {
              ...
              value: arrayInputValue(ciliumIPv4Pool).join(', '),
            },
            {
              label: t('IPv4 Mask Size'),
              value: ciliumIPv4MaskSize,
            },
            {
              label: t('Kube Proxy Replacement'),
              value: kubeProxyReplacement,
            },
            {
              label: t('Operator Replicas'),
              value: ciliumOperatorReplicas,
            },
          ]
        : []),
      {
